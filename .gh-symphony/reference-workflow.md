...
| ------ | ---- | ------------ |
| Draft | unset | Role unset. Must be explicitly configured in WORKFLOW.md. |
| Todo | unset | Role unset. Must be explicitly configured in WORKFLOW.md. |
| Plan Review | unset | Role unset. Must be explicitly configured in WORKFLOW.md. |
